...
const schema = [
    ...
    { table: 'drivers', col: 'verify_token_hash', type: 'TEXT' },
    { table: 'drivers', col: 'verify_token_expires_at', type: 'TEXT' },
    ...
    { table: 'empresas', col: 'verify_token_hash', type: 'TEXT' },
    { table: 'empresas', col: 'verify_token_expires_at', type: 'TEXT' },
